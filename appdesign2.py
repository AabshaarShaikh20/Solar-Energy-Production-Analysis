...
try:
    model = joblib.load('solarproject.pkl')  #
    st.write("<h2 style='color: green;'>Model loaded successfully.</h2>", unsafe_allow_html=True)
except Exception as e:
    model = None
...
st.write("<p style='text-align: center; color: #08A04B;'>Enter the environmental variables to predict the solar power generation:</p>", unsafe_allow_html=True)
